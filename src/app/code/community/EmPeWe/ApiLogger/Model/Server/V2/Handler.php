...
class EmPeWe_ApiLogger_Model_Server_V2_Handler extends Mage_Api_Model_Server_V2_Handler
{
    ...
    public function __construct()
    {
        ...
        $this->strLogfile = Mage::getStoreConfig('apilogger_options/config/apilogger_v2_log_file') ? Mage::getStoreConfig('apilogger_options/config/apilogger_v2_log_file') : 'EmPeWe_ApiLogger.log';
